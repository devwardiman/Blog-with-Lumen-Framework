export default {
    ...
    <main class="container">
        <div class="d-flex align-items-center p-3 my-3 bg-purple rounded shadow-sm">
			...
			<div class="lh-1">
                <h1 class="h6 mb-0 lh-1">Administrator</h1>
                <small>Pengelolah Artikel dan Komentar</small>
            </div>
        </div>

        <div class="my-3 p-3 bg-body rounded shadow-sm">
            <h6 class="border-bottom pb-2 mb-0">Daftar Admin</h6>
	...
	methods: {
		refresh() {
			fetch(`/api/user/writer?page=${this.page}`, {
				method: "GET",
				headers: {
