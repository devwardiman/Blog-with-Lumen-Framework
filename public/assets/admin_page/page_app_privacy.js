export default {
        ...
        <div class="bd-intro pt-2 ps-lg-2">
            <div class="d-md-flex flex-md-row-reverse align-items-center justify-content-between">
                <div class="mb-3 mb-md-0 d-flex">
                    <router-link :to="{path: '/app/article', query: {type: 'privacy'}}" class="btn btn-sm btn-bd-light rounded-2">New Privacy Policy</router-link>
                </div>
                <h1 class="bd-title mb-0" id="content">Privacy Policy</h1>
            </div>
            <p class="bd-lead">Ini adalah daftar Privacy Policy yang telah dibuat</p>
        </div>
	...
	methods: {
		refresh() {
			fetch(`/api/article/privacy?page=${this.page}`, {
				method: "GET",
				headers: {
		...
		gotoArtcile(id) {
			this.$router.push({ path: "/app/article", query: { type:'privacy', id: id } });
		},
	},
	mounted() {
		this.refresh();
